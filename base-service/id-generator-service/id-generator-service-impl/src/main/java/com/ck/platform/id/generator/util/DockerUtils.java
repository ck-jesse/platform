package com.ck.platform.id.generator.util;
...
public abstract class DockerUtils {
     ...
     */
    private static final String ENV_KEY_HOST = "ID_GEN_HOST";
    private static final String ENV_KEY_PORT = "ID_GEN_HTTP_PORT";
    private static final String ENV_KEY_PORT_ORIGINAL = "ID_GEN_HOST_PORT_8080";
